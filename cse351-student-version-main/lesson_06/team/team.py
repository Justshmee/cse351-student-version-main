...
Purpose: Team Activity: Speed up word search solver
"""
...
class Board():
    ...
    def __init__(self):
        ...
        self.board = [
            ['L','S','O','D','A','E','O','M','A','A','I','I','A','S','S','A','M','G','R','C','O','D','A','I','R'],
    ...
    # 🚀 Optimized word check (no deepcopy, no rollback)
    def _word_at_this_location(self, row, col, direction, word):
        ...
        # Highlight only after full match
    ...
    def find_word(self, word):
        ...
        for row in range(self.size):
            for col in range(self.size):
                ...
                # 🚀 Skip immediately if first letter doesn't match
